...
from eng_bot.bot_settings import bot_link, insta_login, insta_pass, telegram_token
...
def list_handl(update, context):
	...
	if(lst_len == 0):
		...
		if(lst_len < DX):	
			forward_message(update, context, "Click <a style=\"color:blue\"href=\"https://t.me/" + bot_link + "?start=-1001386730703\">here</a> and then click 'start' to get the latest list for the group", parse=1);		
		else:
			forward_message(update, context, "Click <a style=\"color:blue\"href=\"https://t.me/" + bot_link + "?start=-1001386730703\">here</a> and then click 'start' to get the latest list for the group", parse=1)
